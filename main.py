...
class QuantProMobilMotor:
    def __init__(self):
        ...
        self.fon_portfoyleri = {
            'TLY': {'tam_ad': 'TLY (Tera Portföy Serbest)', 'hisseler': {'OZATD': 34.27, 'DSTKF': 12.02, 'TEHOL': 9.22}, 'nakit_oran': 18.22, 'nakit_getiri_orani': 50.0},
            'DFI': {'tam_ad': 'DFI (Atlas Portföy Serbest)', 'hisseler': {'IEYHO': 64.78, 'ISKPL': 4.93}, 'nakit_oran': 28.39, 'nakit_getiri_orani': 50.0},
            'TMV': {'tam_ad': 'TMV (Tera Algoritmik)', 'hisseler': {'OZATD': 17.45, 'TEHOL': 10.54}, 'nakit_oran': 53.37, 'nakit_getiri_orani': 50.0}
        }
    ...
    def analiz_yap(self):
        ...
        # BIST 100 için dinamik renk belirleme (Yükseliş: Yeşil, Düşüş: Kırmızı)
...
class QuantProApp(App):
    def build(self):
        ...
        self.baslik = Label(text="[b]QUANT PRO v11.0[/b]\nKurumsal Fon & Risk Merkezi", markup=True, font_size='18sp', size_hint=(1, 0.15), halign='center', valign='middle')
        ...
        self.buton = Button(text="Piyasayı ve Fonları Tara", size_hint=(1, 0.15), background_color=(0.1, 0.6, 0.3, 1))
